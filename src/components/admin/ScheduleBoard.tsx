...
export default function ScheduleBoard() {
  ...
  const [classTypeQuery, setClassTypeQuery] = useState(classTypes[0].name);
  ...
  const [newClassTypeDuration, setNewClassTypeDuration] = useState(60);
  const [newClassTypeCapacity, setNewClassTypeCapacity] = useState(10);
  ...
  const createClassType = () => {
    ...
    const created = { id: `ct-custom-${Date.now()}`, name, description: '', duration_minutes: newClassTypeDuration, max_capacity: newClassTypeCapacity, color_code: '#E11D48' };
